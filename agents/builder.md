...
- **MISSING_WORKER_DONE** -- Closing a seed issue without first sending `worker_done` mail to parent. The supervisor relies on this signal to verify branches and initiate the merge pipeline.
